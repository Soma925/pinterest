...
export default function Body() {
  return (
    ...
    <div className="footer">
        <a className="footerList" href="/">Terms of service</a>
        <a className="footerList" href="/">Privacy Policy</a>
        <a className="footerList" href="/">Help</a>
        <a className="footerList" href="/">Users</a>
    </div>
    </div>
  )
}
